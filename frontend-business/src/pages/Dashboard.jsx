          ...
          <div>
            ...
            {roiExplain && (
              <div style={{ marginTop: 8, padding: '12px 16px', background: 'var(--c-bg-muted)', borderRadius: 'var(--r-md)', fontSize: '0.82rem', color: 'var(--c-text-muted)', lineHeight: 1.65 }}>
                <strong>Extra profit</strong> = (offer price − cost price) × number of redemptions. This shows the additional revenue generated by running deals on Dander versus not running them at all.
              </div>
            )}
          </div>
        </div>
